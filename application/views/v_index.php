...
<head> 
	 <meta charset="utf-8"> 
	  ...
	  <link rel="stylesheet" type="text/css" href="http://localhost/rentalbuku/asset/css/stylebuku.css"> 
	</head> 
	<body>  
		<div id="wrapper">   
			<header>    
			...
			<section>  
				...
				<p align='justify'>Pada pengertian codeigniter di atas tadi di jelaskan bahwa codeigniter menggunakan metode MVC. Apa itu MVC? kita juga harus mengetahui apa itu MVC sebelum masuk dan lebih jauh dalam belajar codeigniter.</p>    <p>MVC adalah teknik atau konsep yang memisahkan komponen utama menjadi tiga komponen yaitu model, view dan controller.</p>
				<ol type="a">    
				 <li>Model</li> 
